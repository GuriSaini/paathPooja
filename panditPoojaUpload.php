    ...
    <div class="container">
		...
		<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="calnder/addEvent.php">
          ...
          <div class="form-group">
					<label for="pooja" class="col-sm-2 control-label">Pooja List</label>
					<div class="col-sm-10">
          <select name="pooja" class="form-control" id="pooja">
                <option value="">Pooja List</option>
                      <?php
                      $qurey="SELECT * FROM `pooja`";
                      mysqli_set_charset($connection,'utf8');
                      $sql = mysqli_query($connection,$qurey);
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			<form class="form-horizontal" method="POST" action="calnder/editEventTitle.php">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    var calendar = $('#calendar').fullCalendar({
			...
			eventRender: function(event, element) {
				element.bind('dblclick', function() {
					...
					$('#ModalEdit #pooja').val(event.pooja);
